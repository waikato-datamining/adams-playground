// https://github.com/deepjavalibrary/djl/blob/v0.29.0/basicdataset/src/main/java/ai/djl/basicdataset/cv/classification/Mnist.java
...
public final class Mnist extends ArrayDataset {
  ...
  public static final Repository REPOSITORY = Repository.newInstance("BasicDataset", DJL_REPO_URL);

  public static final String GROUP_ID = "ai.djl.basicdataset";
  ...
  /** A builder for a {@link ai.djl.basicdataset.cv.classification.Mnist}. */
